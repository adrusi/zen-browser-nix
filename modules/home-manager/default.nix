...
let
  ...
  nativeMessagingHostsJoined = pkgs.symlinkJoin {
    ...
    paths = [
      ...
      (pkgs.writeTextDir "lib/zen/native-messaging-hosts/.keep" "")
    ...
    programs.zen-browser = {
      ...
      package = mkOption {
        ...
        description = ''
          ...
          this should be a wrapped Zen package. For earlier state
          versions it should be an unwrapped Zen package.
          Set to `null` to disable installing Zen.
        '';
      };
  ...
  config = mkIf cfg.enable {
    ...
    assertions = [
      ...
      in {
        ...
        message = "Must have exactly one default Zen profile but found "
